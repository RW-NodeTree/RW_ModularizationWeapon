...
namespace RW_ModularizationWeapon
{
    ...
    public partial class CompModularizationWeapon : CompBasicNodeComp, IEnumerable<(string,Thing,WeaponAttachmentProperties)>
    {
        ...
        private HashSet<string> partIDs = new HashSet<string>();
        private List<ThingComp> cachedThingComps = new List<ThingComp>();
        private List<CompProperties> cachedCompProperties = new List<CompProperties>();
        private Dictionary<string, bool> childTreeViewOpend = new Dictionary<string, bool>();
        private Dictionary<(string, Thing), bool> allowedPartCache = new Dictionary<(string, Thing), bool>();
        private Dictionary<string, WeaponAttachmentProperties> currentPartAttachmentPropertiesCache = new Dictionary<string, WeaponAttachmentProperties>();
        private Dictionary<string, WeaponAttachmentProperties> targetPartAttachmentPropertiesCache = new Dictionary<string, WeaponAttachmentProperties>();
        private Dictionary<(StatDef, Thing), float> statOffsetCache = new Dictionary<(StatDef, Thing), float>();
        private Dictionary<(StatDef, Thing), float> statMultiplierCache = new Dictionary<(StatDef, Thing), float>();
        private Dictionary<(StatDef, Thing), float> statOffsetCache_TargetPart = new Dictionary<(StatDef, Thing), float>();
        private Dictionary<(StatDef, Thing), float> statMultiplierCache_TargetPart = new Dictionary<(StatDef, Thing), float>();
        private Dictionary<Type, List<Tool>> toolsCache = new Dictionary<Type, List<Tool>>();
        private Dictionary<Type, List<VerbProperties>> verbPropertiesCache = new Dictionary<Type, List<VerbProperties>>();
        private Dictionary<Type, List<Tool>> toolsCache_TargetPart = new Dictionary<Type, List<Tool>>();
        private Dictionary<Type, List<VerbProperties>> verbPropertiesCache_TargetPart = new Dictionary<Type, List<VerbProperties>>();
