...
namespace RW_ModularizationWeapon
{
    public partial class ModularizationWeapon
    {
        ...
        public float DrawChildTreeView(
            ...
            Action<string, Thing?, ModularizationWeapon>? openEvent,
            Action<string, Thing?, ModularizationWeapon>? closeEvent,
            Action<string, Thing?, ModularizationWeapon>? iconEvent,
            HashSet<(string, ModularizationWeapon)>? Selected
        )
        {
